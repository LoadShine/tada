...
>(({ className, ...props }, ref) => (
    <AccordionPrimitive.Item
        ref={ref}
        className={cn("border-b border-b-border last-of-type:border-b-0", className)}
        {...props}
    />
))
    ...
    <AccordionPrimitive.Header className="flex">
        <AccordionPrimitive.Trigger
            ...
            className={cn(
                ...
                "focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring/80 focus-visible:rounded-sm", // Added subtle focus ring
                className
            )}
            {...props}
        >
